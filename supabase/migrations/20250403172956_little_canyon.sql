/*
  # Fix payment flow task date propagation

  1. New Functions
    - Add specific trigger functions for each task completion to properly propagate dates
    - Ensure VB Jefe Inversiones completion date is used as Solicitud Gerente Comercial start date
    - Fix other task date propagation throughout the payment flow
