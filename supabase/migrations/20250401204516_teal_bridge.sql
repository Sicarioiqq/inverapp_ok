/*
  # Update task completion to unassign users

  1. Changes
    - Update handle_task_status_change function to unassign users when task is completed
    - Clear assignee_id when task status changes to completed
