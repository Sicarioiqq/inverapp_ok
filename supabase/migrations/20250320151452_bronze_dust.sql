/*
  # Fix task completion behavior

  1. Changes
    - Update trigger function to remove task assignments when task is completed
    - Only allow admins to modify completed tasks
    - Maintain completed_at timestamp handling
...
-- Update trigger function to handle task assignments
