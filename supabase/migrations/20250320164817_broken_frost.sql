/*
  # Add started_at field to reservation_flow_tasks

  1. Changes
    - Add started_at column to reservation_flow_tasks table
    - Update trigger to handle started_at field
    - Add index for better performance
    
  2. Notes
    - started_at will be set when task is first assigned or status changes
    - Maintain existing completed_at behavior
*/
