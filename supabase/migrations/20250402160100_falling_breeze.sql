/*
  # Fix commission_flow_tasks trigger function

  1. Changes
    - Update handle_task_status_change function to remove references to reservation_flow_id
    - Fix task completion handling to use commission_flow_id instead
    - Ensure proper task status transitions
...
-- Update handle_task_status_change function to remove reservation_flow_id references
...
-- Update handle_task_completion function to remove reservation_flow_id references
