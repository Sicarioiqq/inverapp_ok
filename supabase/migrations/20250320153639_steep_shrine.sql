/*
  # Add new task to Escrituración stage and reorder tasks

  1. Changes
    - Add 'PENDIENTE CARTA PIE' task at the beginning
    - Reorder existing tasks
    - Update task names and descriptions
    
  2. Notes
    - Delete existing tasks first to avoid conflicts
    - Insert all tasks in correct order
*/
