/*
  # Fix table constraints and relationships

  1. Changes
    - Add indexes for better performance
    - Update constraints with proper syntax
...
-- Establecer valor por defecto para is_second_payment
ALTER TABLE commission_flows
  ALTER COLUMN is_second_payment SET DEFAULT false,
  ALTER COLUMN is_second_payment SET NOT NULL;

-- Agregar restricciones NOT NULL para commission_flow_tasks
ALTER TABLE commission_flow_tasks
