...
const BrokerQuotePage: React.FC = () => {
  ...
  useEffect(() => {
    filterUnidades();
  }, [stockUnidades, searchTerm, selectedProject, selectedTipologia, sortConfig]);
  ...
  const handleSelectUnit = (unidad: StockUnidad) => {
    ...
    // Ocultar la tabla de stock cuando se selecciona una unidad
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-semibold text-gray-800">Stock de Unidades</h2>
            <button 
                        ...
                        <td className="px-2 py-2 whitespace-nowrap text-xs text-center">
                          {unidad.tipo_bien === 'DEPARTAMENTO' ? (
                            ...
                            <button
                              ...
                              disabled={addedSecondaryUnits.some(u => u.id === unidad.id)}
                              className={`px-2 py-1 text-xs rounded ${
        ...
        {selectedUnidad && (
          <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Unidad Seleccionada</h2>
        ...
        {selectedUnidad && commercialPolicy && (
          <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Política Comercial</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {commercialPolicy.observaciones && (
                <div className="md:col-span-2">
                  ...
                  <div className="mt-2 bg-gray-50 p-3 rounded-md">
                    <p className="text-sm whitespace-pre-line">{commercialPolicy.observaciones}</p>
                  </div>
                </div>
              )}
            </div>
        ...
        {selectedUnidad && addedSecondaryUnits.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Unidades Secundarias</h2>
